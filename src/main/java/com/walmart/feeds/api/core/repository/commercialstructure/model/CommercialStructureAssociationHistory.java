...
public class CommercialStructureAssociationHistory extends AuditableEntity {
    ...
    @Builder
    public CommercialStructureAssociationHistory(LocalDateTime creationDate, LocalDateTime updateDate, String user, UUID id,
    ...
    @Tolerate
    public CommercialStructureAssociationHistory(){
