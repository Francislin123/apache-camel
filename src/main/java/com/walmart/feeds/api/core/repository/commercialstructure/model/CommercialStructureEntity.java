...
@Entity
@Getter
@EqualsAndHashCode(callSuper = true, exclude = "associationEntityList")
...
public class CommercialStructureEntity extends AuditableEntity{
    ...
    @Builder
    public CommercialStructureEntity(LocalDateTime creationDate, LocalDateTime updateDate, String user, UUID id, String archiveName, String slug, PartnerEntity partner, ImportStatus status, List<CommercialStructureAssociationEntity> associationEntityList) {
